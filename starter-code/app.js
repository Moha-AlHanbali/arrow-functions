...
// - Because arrow functions retained the (this) value of the enclosing functional scope, while the value of (this) is the same as the (this) of the enclosing scope.